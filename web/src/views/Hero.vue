<template>
  <div class="page-hero" v-if="model">
    <div class="topbar bg-black py-2 px-3 d-flex ai-center text-white">
      <img src="../assets/logo.png" height="30" class="px-1" />
      <div class="px-2 flex-1">
        <span class="text-white">王者荣耀</span>
        <span class="ml-4 text-white">攻略站</span>
      </div>
        ...
        <div>
          <div class="px-3 pt-2 bg-white border-bottom">
            ...
            <div class="skills mt-4">
              <div class="d-flex jc-around pt-3">
                <img
                  class="icon"
              ...
              <div v-if="currentSkill">
                <div class="d-flex pt-4 m-2 pb-3">
          ...
          <m-card plain icon="Menu" title="使用技巧">
            <div class="pb-2">{{ model.usageTips }}</div>
          </m-card>
          <m-card plain icon="Menu" title="对抗技巧">
             <div class="pb-2">{{ model.battleTips }}</div>
            
          </m-card>
          <m-card plain icon="Menu" title="团战技巧">
            <div class="pb-2">{{ model.teamTips }}</div>
          </m-card>
